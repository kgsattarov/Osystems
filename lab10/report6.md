...
2. Запишем в файл txt все названия файлов в каталоге /etc
![Записываем информацию](image/1.png)
<center>Рис 1</center>
3. Затем необходимо вывести эту самую информацию 
![Выводим информацию](image/2.png)
<center>Рис 2</center>
...
<center>Рис 3</center>
5. Постранично вывод на экран имена файлов на h
...
![Запуск процесса](image/5.png)
<center>Рис 5</center>
7. Удаление файла
![Я удаляю файл](image/6.png)
<center>Рис 6</center>
...
<center>Рис 8</center>
Определить идентификатор процесса можно также, используя команды "pgrep gedit" или "pidof gedit".
10. Прочесть мануал kill и завершить grep
![Убиваем процесс даааааа так его](image/9.png)
<center>Рис 9</center>
11. Читаем мануал о df и du
![Мануал](image/10.png)
<center>Рис 10</center>
12. Посмотреть все файлы с помощью find
![Find очень интересная команда](image/11.png)
<center>Рис 11</center>

# Вывод:
В данной лабораторной работе я научился более продвинутым командам для использования Linux. Так же меня порадовали фоновые процессы.
